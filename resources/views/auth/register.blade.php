            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="type_id" class="col-md-4 col-form-label text-md-end">{{ __('Tipo Identificación') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="cc_number" class="col-md-4 col-form-label text-md-end">{{ __('Numero Identificación') }}</label>
